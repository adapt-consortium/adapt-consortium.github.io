...
var i_45354 = (0);
while(true){
if((i_45354 < arr.length)){
(arr[i_45354] = null);

var G__45357 = (i_45354 + (1));
i_45354 = G__45357;
continue;
} else {
}
...
var i_45404 = (self__.level + (1));
while(true){
if((i_45404 <= (new_level + (1)))){
(update[i_45404] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_45413 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_45413[i]));
} else {
x__$2.forward.push((((i < links_45413.length))?(links_45413[i]):null));
}

if((i < links_45413.length)){
(links_45413[i] = x__$2);
} else {
links_45413.push(x__$2);
}
...
var i_45420 = (0);
while(true){
if((i_45420 <= self__.level)){
var links_45421 = (update[i_45420]).forward;
if((x__$1 === (((i_45420 < links_45421.length))?(links_45421[i_45420]):null))){
(links_45421[i_45420] = (x__$1.forward[i_45420]));

var G__45425 = (i_45420 + (1));
i_45420 = G__45425;
continue;
} else {
var G__45426 = (i_45420 + (1));
i_45420 = G__45426;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__45466 = nx;
var G__45467 = (level__$1 - (1));
x = G__45466;
level__$1 = G__45467;
continue;
} else {
var G__45468 = x;
var G__45469 = (level__$1 - (1));
x = G__45468;
level__$1 = G__45469;
continue;
}
