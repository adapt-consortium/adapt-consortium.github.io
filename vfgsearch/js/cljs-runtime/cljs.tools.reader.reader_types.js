...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_42169 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_42169(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_42171 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_42171(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_42172 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_42172(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_42174 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_42174(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_42175 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_42175(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_42176 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_42176(reader);
}
});
...
var G__42220 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__42221 = s.append(c);
c = G__42220;
s = G__42221;
continue;
}
