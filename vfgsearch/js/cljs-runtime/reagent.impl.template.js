...
var G__52278 = o;
reagent.impl.template.goog$module$goog$object.set(G__52278,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__52296__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__52296 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__52297__i = 0, G__52297__a = new Array(arguments.length -  0);
while (G__52297__i < G__52297__a.length) {G__52297__a[G__52297__i] = arguments[G__52297__i + 0]; ++G__52297__i;}
  args = new cljs.core.IndexedSeq(G__52297__a,0,null);
} 
return G__52296__delegate.call(this,args);};
G__52296.cljs$lang$maxFixedArity = 0;
G__52296.cljs$lang$applyTo = (function (arglist__52298){
var args = cljs.core.seq(arglist__52298);
return G__52296__delegate(args);
});
G__52296.cljs$core$IFn$_invoke$arity$variadic = G__52296__delegate;
return G__52296;
})()
;
} else {
...
var G__52279 = o;
reagent.impl.template.goog$module$goog$object.set(G__52279,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__52302__i < G__52302__a.length) {G__52302__a[G__52302__i] = arguments[G__52302__i + 0]; ++G__52302__i;}
  args = new cljs.core.IndexedSeq(G__52302__a,0,null);
} 
...
var args = cljs.core.seq(arglist__52303);
...
var G__52280 = props;
var G__52280__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52280,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__52280);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52280__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__52281 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52281,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__52281;
}
})(),id_class);
...
var G__52282 = (cljs.core.count(argv) - first_child);
switch (G__52282) {
case (0):
...
var vec__52283 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52283,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52283,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52283,(2),null);
...
var temp__5808__auto___52309 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___52309 == null)){
} else {
var key_52310 = temp__5808__auto___52309;
(jsprops.key = key_52310);
}
...
var temp__5808__auto___52311 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___52311 == null)){
} else {
var key_52312 = temp__5808__auto___52311;
(jsprops.key = key_52312);
}
...
var temp__5808__auto___52316 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___52316 == null)){
} else {
var key_52317 = temp__5808__auto___52316;
(jsprops.key = key_52317);
}
...
var temp__5808__auto___52318 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___52318 == null)){
} else {
var key_52319 = temp__5808__auto___52318;
(jsprops.key = key_52319);
}
...
var temp__5808__auto___52320 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___52320 == null)){
} else {
var key_52321 = temp__5808__auto___52320;
(jsprops.key = key_52321);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52286_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__52286_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__52287 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52287,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52287,(1),null);
...
break;
default:
var G__52333 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__52334 = compiler;
v = G__52333;
compiler = G__52334;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template52293 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template52293 = (function (opts,id,fn_to_element,meta52294){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template52293.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_52295,meta52294__$1){
var self__ = this;
var _52295__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template52293(self__.opts,self__.id,self__.fn_to_element,meta52294__$1));
}));

(reagent.impl.template.t_reagent$impl$template52293.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_52295){
var self__ = this;
var _52295__$1 = this;
return self__.meta52294;
}));

(reagent.impl.template.t_reagent$impl$template52293.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template52293.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template52293.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template52293.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template52293.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta52294","meta52294",1851561854,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template52293.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template52293.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template52293");

(reagent.impl.template.t_reagent$impl$template52293.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template52293");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template52293.
 */
reagent.impl.template.__GT_t_reagent$impl$template52293 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template52293(opts__$1,id__$1,fn_to_element__$1,meta52294){
return (new reagent.impl.template.t_reagent$impl$template52293(opts__$1,id__$1,fn_to_element__$1,meta52294));
});

}

return (new reagent.impl.template.t_reagent$impl$template52293(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
