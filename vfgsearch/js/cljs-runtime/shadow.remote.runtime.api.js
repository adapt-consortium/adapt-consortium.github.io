...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_45766 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_45766(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_45774 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_45774(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_45775 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_45775(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_45778 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_45778(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_45790 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_45790(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_45797 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_45797(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__45760,callback){
var map__45761 = p__45760;
var map__45761__$1 = cljs.core.__destructure_map(map__45761);
var input = map__45761__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45761__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45761__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
